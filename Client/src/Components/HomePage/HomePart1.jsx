    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 landing-bg items-center lg:items-start lg:px-40 lg:py-12 justify-center">
        <div>
          <div className="text-center lg:text-left mb-6 lg:leading-loose">
            <h1 className="color-1 mt-12 text-base lg:text-xl font-extrabold">
              Timely
              <span className="text-white font-extrabold pl-2">
                time tracking software
              </span>
            </h1>
            <h2 className="text-white  mt-3 font-extrabold text-4xl lg:text-7xl">
              Say hello to
            </h2>
            <span className="color-2 font-extrabold text-4xl lg:text-7xl lg:pr-12">
              automatic time tracking
            </span>
            <p className="px-12 mt-6 lg:px-0 text-white font-normal text-base lg:text-xl lg:pr-80">
          ...
          <div className="bg-white mx-3 mt-12 mb-12 rounded-2xl flex justify-around items-center lg:w-full lg:mx-0 lg:py-1 lg:px-3">
            <input
              type="text"
              placeholder="Enter your work mail id"
              className="rounded-lg my-1 py-1 px-1 lg:px-3 lg:my-2 lg:py-3 lg:h-auto lg:w-3/4 lg:mr-3 border-2 border-none active:ring-white  focus:ring-white focus:border-none"
            />
            <button className="bg-color-1 rounded-xl text-white py-2.5 px-2.5 lg:px-3 lg:my-0 text-xs lg:text-sm lg:py-4">
              Start my free trial
            </button>
          </div>
      ...
      <div className="grid grid-col-1 my-6">
        <div className="flex flex-col items-center">
          <img
            ...
            alt=""
          />
          <h3 className="my-3 text-2xl lg:text-4xl font-bold text-slate-800 px-3">
          ...
          <Link
            to="/"
            className="my-3 color-3 text-base lg:text-lg font-normal"
          >
            How it all works
          </Link>
        ...
        <div className="grid grid-col-3 gap-9 my-6 lg:flex justify-center items-center">
          <div className="flex flex-col items-center justify-center text-center px-3">
            ...
            <h4 className="my-3 text-2xl lg:text-4xl font-bold text-slate-800 px-3">
              Track time
            </h4>
            ...
            <Link
              to="/"
              className="text-base text-slate-600 font-normal underline underline-offset-4 color-3"
            >
        ...
        <div className="grid grid-col-1 gap-9 lg:gap-x-0 mt-32 mb-12">
          <div className="flex flex-col px-4 lg:grid lg:grid-cols-2 lg:items-center lg:justify-center">
            <img
              src={img1}
              alt=""
              className="h-60 mb-6 lg:h-auto lg:w-full lg:px-32"
            />
            <div className="flex flex-col justify-center text-center lg:text-left">
              <h3 className="my-3 text-2xl lg:text-4xl font-bold text-slate-800 px-3 lg:px-0">
        ...
        <div className="grid grid-col-1 gap-9 lg:gap-x-0 my-12 ">
          <div className="flex flex-col px-4 lg:grid lg:grid-cols-2 lg:flex-col-reverse lg:items-center lg:justify-center">
            <img
              ...
              alt=""
              className="h-60 mb-6 lg:h-auto lg:w-full lg:px-32  lg:order-last"
            />
            <div className="flex flex-col justify-center text-center lg:text-left">
              <h3 className="my-3 text-2xl lg:text-4xl font-bold text-slate-800 px-3 lg:px-0 lg:pl-36">
      ...
      <div className="grid grid-col-1 gap-9 lg:gap-x-0 my-12 landing-bg">
        <div className="text-center text-white flex flex-col justify-center items-center">
          <img
            ...
            className="mt-12"
          />
          <h3 className="text-3xl font-extrabold my-3 lg:text-4xl">
            Connect your stack
          </h3>
        ...
        <p className="text-center text-white font-normal text-lg mb-12">
          See Intergration
        </p>
      </div>
      ...
      <div className="flex flex-col justify-center items-center text-center mb-12">
        ...
        <p className="text-base lg:text-lg px-6 text-slate-600 font-normal lg:px-96">
          ...
          benefits of automatic time tracking, with flexible subscription plans
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 text-center lg:gap-x-3 lg:mx-auto lg:w-4/6">
        <div className="bg-slate-100 flex flex-col items-center py-6 rounded-lg mx-6 my-6 lg:mx-0">
          ...
          <Link
            to="/"
            className="font-normal text-slate-700 text-lg lg:text-base my-4 lg:px-2"
          >
      ...
      <div className="grid grid-cols-1  lg:grid-cols-2 text-center lg:flex lg:gap-x-2 lg:mx-auto lg:w-4/6">
        ...
        <div className="flex flex-col items-center justify-center lg:items-start lg:text-left">
          ...
          <p className="text-sm px-6 text-slate-700 mb-3 lg:ml-0 lg:pl-3">
            See how <strong className="color-3">Grant Thornton </strong>{" "}
            leverages Timely’s automation to increase time tracking accuracy and
            efficiency across its Legal and Finance, Tax and Regulatory, and IT
            departments.
          </p>
          <Link
            to="/"
            className="color-3 font-bold text-base underline underline-offset-2 mb-24 lg:ml-3"
          >
      ...
      <div className="grid grid-cols-1 landing-bg">
        <div className="text-white text-center my-6">
          <h1 className="text-3xl font-bold lg:text-4xl">
            Try <span className="color-1">Timely</span> for free!
          </h1>
          <p className="text-base px-4 mt-2 text-slate-50">
          ...
          <div className="bg-white mx-3 mt-6 mb-6 rounded-2xl flex justify-around items-center lg:w-2/5 lg:mx-auto lg:py-1 lg:px-3">
            <input
              type="text"
              placeholder="Enter your work mail id"
              className="rounded-lg my-2 py-1 px-3 text-base lg:px-3 lg:my-1 lg:py-3 lg:h-auto lg:w-3/4 lg:mr-3 border-2 border-none active:ring-white  focus:ring-white focus:border-none"
            />
            <button className="bg-color-1 rounded-xl text-white py-2.5 px-2.5 lg:my-0 text-xs lg:text-sm lg:py-3 lg:px-3">
              Start my free trial
            </button>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-6">
          <p className="text-white  font-bold text-xs  text-center lg:ml-4 lg:text-xs mt-3">
            20 people or more?{" "}
      ...
      <div className="grid grid-cols-1 mt-6 mb-12 lg:grid-cols-2 text-center lg:flex lg:gap-x-2 lg:mx-auto lg:w-4/6">
        <div className="mb-6 order-last lg:order-first w-full lg:w-5/6">
          ...
          <div className="flex justify-center lg:justify-start">
            <button
              ...
              className="bg-color-1 font-normal mb-6 text-white text-base px-6 py-2 cursor-pointer rounded-lg"
            >
              Start free trial
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 w-full gap-x-0 gap-y-12  mx-6 lg:mx-0 lg:gap-x-6 tracking-wide mb-12">
          <div>
            <h2 className="text-slate-900 text-sm text-left font-normal">
              Features
            </h2>
